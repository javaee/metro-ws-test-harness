 ...
 * 
 */
@WebServiceClient(name = "PingService", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/wsrm/roundtrip/server/EchoService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/wsrm/roundtrip/server/EchoService.wsdl");
