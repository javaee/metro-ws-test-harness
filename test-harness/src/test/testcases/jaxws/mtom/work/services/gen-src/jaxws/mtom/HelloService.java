 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://example.org/mtom", wsdlLocation = "file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/mtom/hello.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/mtom/hello.wsdl");
