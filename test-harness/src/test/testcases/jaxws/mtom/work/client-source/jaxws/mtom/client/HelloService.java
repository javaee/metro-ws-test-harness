 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://example.org/mtom", wsdlLocation = "file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/mtom/work/services/war/WEB-INF/wsdl/hello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://example.org/mtom", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/mtom/work/services/war/WEB-INF/wsdl/hello.wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://example.org/mtom", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.org/mtom", "HelloPort"), Hello.class, features);
    }
