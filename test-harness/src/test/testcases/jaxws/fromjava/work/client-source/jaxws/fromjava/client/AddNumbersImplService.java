 ...
 * 
 */
@WebServiceClient(name = "AddNumbersImplService", targetNamespace = "http://server.fromjava/", wsdlLocation = "file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/fromjava/work/services/server/war/WEB-INF/wsdl/AddNumbersImplService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/fromjava/work/services/server/war/WEB-INF/wsdl/AddNumbersImplService.wsdl");
