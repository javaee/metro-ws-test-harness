 ...
 * 
 */
@WebServiceClient(name = "AddNumbersService", targetNamespace = "http://example.org", wsdlLocation = "file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/fromwsdl/work/services/server/war/WEB-INF/wsdl/AddNumbers.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/space/sources/ws-test-harness/trunk/test-harness/src/test/testcases/jaxws/fromwsdl/work/services/server/war/WEB-INF/wsdl/AddNumbers.wsdl");
