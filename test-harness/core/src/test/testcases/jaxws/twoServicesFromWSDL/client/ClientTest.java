 ...
 * holder.
 */
package jaxws.twoServicesFromWSDL.client;
...
public class ClientTest extends TestCase {
    ...
    public void testWs2Client() throws Exception {
        jaxws.twoServicesFromWSDL.client2.AddNumbersPortType port
                = new jaxws.twoServicesFromWSDL.client2.AddNumbersService().getAddNumbersPort();
