...
for (i = 0; i<3; i++ ) {
    p.setText(new JAXBElement<String>(new QName("http://tempuri.org/","Text"),String.class,"Hello There! no" + i));
    p.setSequence(new JAXBElement<String>(new QName("http://tempuri.org/","Sequence"),String.class,"seq! no" + i));
